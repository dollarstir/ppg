  ...
  ?>
		...
		<div id="slider1" class="rev_slider"  data-version="5.0">
			<ul>
				<li data-transition="parallaxvertical">
					<img src="app/view/img/slides/1.jpg"  alt="" width="1920" height="705" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
				...
				<li data-transition="parallaxvertical">
					<img src="app/view/img/slides/2.jpg"  alt=""  width="1920" height="705" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="2" >
	                ...
	                <div class="row">
	                  <div class="col-sm-4">
	                    <div class="event-thumb">
	                      <div class="thumb">
	                        <img class="full-width" src="app/view/img/event/1.jpg" alt="">
	                      </div>
	                      <ul class="event-date">
	                        <li class="date">28</li>
	          ...
	          <div class="col-sm-12 col-md-12 col-lg-6 md-col6-center m-topm50">
	            ...
	            <div class="featured-causes">
	              <div class="row">
	                <div class="col-sm-6">
	                  <div class="thumb">
	                    <img class="full-width" src="app/view/img/causes/b1.jpg" alt="">
			...
			<div class="row">
	          <div class="col-sm-12 col-md-4 col-lg-4">
	            <div class="causes sm-col5-center">
	              <div class="thumb">
	                <img class="full-width" alt="" src="app/view/img/causes/1.jpg">
	          ...
	          <div class="col-sm-12 col-md-4 col-lg-4">
	            <div class="causes sm-col5-center">
	              <div class="thumb">
	                <img class="full-width" alt="" src="app/view/img/causes/2.jpg">
	                <div class="donate-piechart">
	                  <div class="piechart-block">
	                    <div class="piechart style-one"  data-fg-color="rgba(250,119,68,1)" data-value=".75">
						  <span>.75</span>
	          ...
	          <div class="col-sm-12 col-md-4 col-lg-4">
	            <div class="causes sm-col5-center">
	              <div class="thumb">
	                <img class="full-width" alt="" src="app/view/img/causes/3.jpg">
	                <div class="donate-piechart">
	                  <div class="piechart-block">
	                    <div class="piechart style-one"  data-fg-color="rgba(250,119,68,1)" data-value=".75">
						  <span>.75</span>
    ...
    <section class="gallery-section pb_2">
        ...
        <div class="clearfix">       
            ...
            <div class="image-box">
                <div class="inner-box">
                    <figure class="image"><a href="img/gallery/s1.jpg" class="lightbox-image"><img src="app/view/img/gallery/s1.jpg" alt=""></a></figure>
            ...
            <div class="image-box">
                <div class="inner-box">
                    <figure class="image"><a href="img/gallery/s2.jpg" class="lightbox-image"><img src="app/view/img/gallery/s2.jpg" alt=""></a></figure>
            ...
            <div class="image-box">
                <div class="inner-box">
                    <figure class="image"><a href="img/gallery/s3.jpg" class="lightbox-image"><img src="app/view/img/gallery/s3.jpg" alt=""></a></figure>
            ...
            <div class="image-box">
                <div class="inner-box">
                    <figure class="image"><a href="img/gallery/s4.jpg" class="lightbox-image"><img src="app/view/img/gallery/s4.jpg" alt=""></a></figure>
            ...
            <div class="image-box">
                <div class="inner-box">
                    <figure class="image"><a href="img/gallery/s5.jpg" class="lightbox-image"><img src="app/view/img/gallery/s5.jpg" alt=""></a></figure>
            ...
            <div class="image-box">
                <div class="inner-box">
                    <figure class="image"><a href="img/gallery/s6.jpg" class="lightbox-image"><img src="app/view/img/gallery/s6.jpg" alt=""></a></figure>
            ...
            <div class="image-box">
                <div class="inner-box">
                    <figure class="image"><a href="img/gallery/s7.jpg" class="lightbox-image"><img src="app/view/img/gallery/s7.jpg" alt=""></a></figure>
            ...
            <div class="image-box">
                <div class="inner-box">
                    <figure class="image"><a href="img/gallery/s8.jpg" class="lightbox-image"><img src="app/view/img/gallery/s8.jpg" alt=""></a></figure>
			...
			<div class="row">
				<div class="col-md-4 col-sm-12 sm-col5-center m-btms40">
					<div class="single-blog-post">
						<div class="img-box">
							<img class="full-width" src="app/view/img/blog/1.jpg" alt="">
							<div class="overlay">
								<div class="box">
									<div class="content">
										<ul>
				...
				<div class="col-md-4 col-sm-12 sm-col5-center m-btms40">
					<div class="single-blog-post">
						<div class="img-box">
							<img class="full-width" src="app/view/img/blog/2.jpg" alt="">
							<div class="overlay">
								<div class="box">
									<div class="content">
										<ul>
				...
				<div class="col-md-4 col-sm-12 sm-col5-center m-btms40">
					<div class="single-blog-post">
						<div class="img-box">
							<img class="full-width" src="app/view/img/blog/3.jpg" alt="">
							<div class="overlay">
								<div class="box">
									<div class="content">
										<ul>
