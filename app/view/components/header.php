...
<head>
	...
	<link rel="stylesheet" href="app/view/css/responsive.css">


	<!-- favicon   -->
	<link rel="apple-touch-icon" sizes="180x180" href="app/view/img/favicon/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="app/view/img/favicon/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="app/view/img/favicon/favicon-16x16.png">
	...
	<section class="top-bar">
		<div class="container">
			...
			<div class="left-text pull-left">
				<p><span>Support Us :</span> passionplanetghana1@gmail.com</p>
			</div> <!-- /.left-text -->
	...
	<header class="header">
		<div class="container">
			<div class="logo pull-left">
				<a href="index-2.html">
					<img src="app/view/img/resources/logo.png" alt="Awesome Image" style="width:150px;height:100px;border-radius:20px;"/>
				</a>
			</div>
	                    ...
	                    <div class="modal-content">
	                      ...
	                      <div class="modal-body">
		                    <div class="donation-form-outer">
				            	<form action="https://hasan.themexlab.com/new/charity-home-html/contact.html" method="post">
				                    ...
				                    <div class="form-portlet">
				                        ...
				                        <div class="payment-option-logo"><img alt="" src="app/view/img/resources/payment-logos.png" class="img-responsive"></div>
				                        <br>
				                    </div>
